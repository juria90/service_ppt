...
class HTMLWriter:
    ...
    def __init__(self, process_bible_tags):
        super().__init__()
    ...
    def _write_html_header(self, file, title):
        print(f'''<html>
<head>
...
''', file=file, end='')
    ...
    def _write_book_begin(self, file, book):
        self._write_html_header(file, book.name)
    ...
    def _write_index(self, file, bible):
        ...
        self._write_html_header(file, bible.name)
