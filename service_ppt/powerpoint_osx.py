"""PowerPoint automation for macOS using AppleScript.

This module implements App and Presentation classes for automating PowerPoint
on macOS using AppleScript. This implementation provides basic slide manipulation
features, though some advanced features may be limited compared to the Windows COM
implementation.
