"""Base classes for PowerPoint automation.

This module provides base classes (PresentationBase and PPTAppBase) that define
the common interface for PowerPoint automation across different platforms.
It includes text caching, slide management, and find/replace functionality.
"""
