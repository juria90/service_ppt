...
class PreferencesDialog(wx.adv.PropertySheetDialog):
    ...
    def __init__(self, parent, config, *args, **kwargs):
        ...
        wx.adv.PropertySheetDialog.__init__(self, parent, title=_('Preferences'),
                                            style=wx.DEFAULT_DIALOG_STYLE | resize_border, *args, **kwargs)
    ...
    def create_bible_settings_page(self, parent):
        ...
        sizer.Add(stext, pos=(row, 0), span=DEFAULT_SPAN,
